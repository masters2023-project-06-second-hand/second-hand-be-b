...
import static com.codesquad.secondhand.domain.product.ProductTestUtils.MODIFIED_CATEGORY_NAME;
import static com.codesquad.secondhand.domain.product.ProductTestUtils.MODIFIED_CATEGORY_NAME1;
import static com.codesquad.secondhand.domain.product.ProductTestUtils.MODIFIED_IMG_URL_1;
import static com.codesquad.secondhand.domain.product.ProductTestUtils.MODIFIED_IMG_URL_2;
...
class ProductTest {
    ...
    public static void modifiedProduct(Product product) {
        ...
        product.modifyProduct(MODIFIED_PRODUCT_NAME, MODIFIED_PRODUCT_CONTENT, MODIFIED_PRODUCT_PRICE, modifiedCategory.getId(),
