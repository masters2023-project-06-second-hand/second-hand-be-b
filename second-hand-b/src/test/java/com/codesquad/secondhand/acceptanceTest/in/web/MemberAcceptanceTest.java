...
import static com.codesquad.secondhand.acceptanceTest.in.web.MemberSteps.관심상품에_담는다;
import static com.codesquad.secondhand.acceptanceTest.in.web.MemberSteps.관심상품에_제거한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.MemberSteps.관심상품은_담은_응답_검증;
import static com.codesquad.secondhand.acceptanceTest.in.web.MemberSteps.나의_관심상품_목록_조회_검증한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.MemberSteps.나의_관심상품_목록_조회한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.MemberSteps.나의_관심상품의_카테고리_목록_조회_결과_검증한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.MemberSteps.나의_관심상품의_카테고리_목록_조회한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.MemberSteps.나의_상태별_판매상품의_목록_조회_결과_검증한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.MemberSteps.나의_카테고리별_관심상품_목록_조회_결과_검증한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.MemberSteps.나의_판매상품_목록_조회한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.MemberSteps.나의_판매상품_목록을_상태별_조회한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.MemberSteps.나의_판매상품의_목록_조회_결과_검증한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.MemberSteps.멤버의_정보를_요청한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.MemberSteps.멤버정보_요청을_검증한다;
