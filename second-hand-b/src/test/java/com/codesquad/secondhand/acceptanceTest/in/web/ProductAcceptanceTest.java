...
import static com.codesquad.secondhand.acceptanceTest.in.web.ProductSteps.regionId로_상품목록을_조회한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.ProductSteps.regionId와_categoryId로_지역목록을_조회한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.ProductSteps.regionid로_조회된_상품몰록_검증;
import static com.codesquad.secondhand.acceptanceTest.in.web.ProductSteps.regionid와_categoryId로_조회된_지역목록_검증;
import static com.codesquad.secondhand.acceptanceTest.in.web.ProductSteps.상품등록을_검증한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.ProductSteps.상품상세를_조회한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.ProductSteps.상품상세조회를_검증한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.ProductSteps.상품상태를_수정한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.ProductSteps.상품상태수정을_검증한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.ProductSteps.상품수정을_검증한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.ProductSteps.상품을_등록한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.ProductSteps.상품을_삭제한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.ProductSteps.상품을_수정한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.ProductSteps.잘못된_상품_등록요청;
import static com.codesquad.secondhand.acceptanceTest.in.web.ProductSteps.잘못된_상품등록_응답_검증한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.ProductSteps.잘못된_상품수정_요청을_검증한다;
import static com.codesquad.secondhand.acceptanceTest.in.web.ProductSteps.잘못된_요청으로_상품을_수정한다;
